...
TEXTS: dict[Language, dict[str, str]] = {
    "en": {
        ...
        "workshop_short": "Maps",
        "workshop_desc": "Play, import, or create map files",
        "choose_map": "Choose a map",
        "builtin_map": "Built-in",
        "custom_map": "File",
        "new_map": "New map",
        ...
        "export_map": "Export",
        "play_map": "Play",
        "drop_map_hint": "Drop a .json map file here to import · Left/Right changes page",
        "editor_hint": "Click/drag to draw walls · Green cells are the protected spawn area",
    ...
    "zh": {
        ...
        "export_map": "导出",
        "play_map": "试玩",
        "drop_map_hint": "拖入 .json 地图文件即可导入 · 左右键翻页",
        "editor_hint": "点击或拖动绘制墙体 · 绿色格子为受保护出生区",
        "bonus_food": "奖励食物",
        "ready": "按方向键开始游戏",
        "paused": "游戏已暂停",
        "game_over": "游戏结束",
